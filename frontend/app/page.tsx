      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center text-center p-4 overflow-hidden">
        ...
        <div className="container mx-auto relative z-20 text-white">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link
              href="#track"
              className="group inline-flex items-center justify-center h-14 px-10 rounded-full bg-white text-blue-600 font-bold text-lg shadow-2xl hover:shadow-white/25 transition-all duration-300 transform hover:scale-105"
              prefetch={false}
            >
              Cek Status Laundry
              <svg
            ...
            <Link
              href="#services"
              className="inline-flex items-center justify-center h-14 px-10 rounded-full bg-transparent border-2 border-white text-white font-bold text-lg hover:bg-white hover:text-blue-600 transition-all duration-300 transform hover:scale-105"
              prefetch={false}
            >
              Lihat Layanan
            </Link>
